...
<div class="container-fluid">
<div class="col-md-12"><h3 id="titulo">Listado de Materias UCA: <?php echo $_GET["periodo"] ?></h3></div>
...
?>
<hr>
<li><a target="_blank" title="Imprimir Per&iacute;odo: <?php echo $_GET["periodo"]; ?>" href="pdf/documentos/ver_materias.php?orden=profes&periodo=<?php echo $_GET["periodo"]; ?>">Orden Alfab. Profesores</a></li>
...
<!-- FIN IMPRIMIR LISTADO -->
  ...
  <div class="col-md-6">
   ...
   <form class="form-horizontal" role="form">
     <input type="text" class="form-control" id="q" placeholder="Materia" onchange="load(1);">
...
<script type="text/javascript" src="js/materias_periodo.js"></script>
</body>
</html>
<script>
...
var nombre = "¿Realmente deseas eliminar la materia: " + b + "?";
   ...
   //Redireccionamos si das a aceptar
	...
	$.ajax({url: id, success: function(result){
            $("#resultados").html(result).hide();
			load(1);
			$("#resultados").html(result).fadeIn(1000);
        }});
