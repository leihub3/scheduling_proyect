...
if(isset($_GET["msg"]) && $_GET["msg"] == "OK"){
	echo "<script>alert('Materias copiadas con exito!');</script>";
}
...
$periodo = $_GET["periodo"] ;//date("Y") . " - " . $semestre;
$anio = substr("$periodo",0,4);
$cursos = $_GET["cursos"]; //array("'1er A&ntilde;o'","'2do A&ntilde;o'","'3er A&ntilde;o'","'4to A&ntilde;o'","'5to A&ntilde;o'"); //$_POST['states']; // return Array
...
<link rel="stylesheet" href="css/bootstrap-multiselect.css">
  ...
  <script src="js/bootstrap-multiselect.js?456"></script>
<style>
table td{
font-weight:bold;
}
...
<div class="col-md-12"><h3 id="titulo">CRONOGRAMA UCA - <?php echo $_GET["periodo"] ; ?></h3> <!-- $semestre . " " . $anio -->
<div style="text-align:center"><strong>Cursos: </strong><?php echo $curso; ?></div></div>
...
<form role="form" method="get" action="cronogramas_periodo.php" ><!--  -->
	  ...
	  <input type="hidden" value="<?php echo stripslashes($curso); ?>" id="select_curso" name="cursos">
	  <input type="hidden" value="<?php echo $periodo; ?>" id="select_periodo" name="periodo">
	  <!--<input type="hidden" value="OK" id="select_mostrar" name="mostrar">-->
...
<!-- Select Multiple FIN--> 
  ...
  <ul class="nav nav-tabs">
    <li <?php echo $tab_lunes; ?>><a href="cronogramas_periodo.php?dia=lunes&mostrar=OK&cursos=<?php echo $curso;?>&periodo=<?php echo $periodo; ?>" onclick="load(1);">Lunes</a></li> <!-- " -->
    <li <?php echo $tab_martes; ?>><a href="cronogramas_periodo.php?dia=martes&mostrar=OK&cursos=<?php echo $curso;?>&periodo=<?php echo $periodo; ?>" onclick="load(1);">Martes</a></li> <!--  -->
    <li <?php echo $tab_miercoles; ?>><a href="cronogramas_periodo.php?dia=miercoles&mostrar=OK&cursos=<?php echo $curso;?>&periodo=<?php echo $periodo; ?>" onclick="load(1);">Mi&eacute;rcoles</a></li>
    <li <?php echo $tab_jueves; ?>><a href="cronogramas_periodo.php?dia=jueves&mostrar=OK&cursos=<?php echo $curso;?>&periodo=<?php echo $periodo; ?>" onclick="load(1);">Jueves</a></li>
	<li <?php echo $tab_viernes; ?>><a href="cronogramas_periodo.php?dia=viernes&mostrar=OK&cursos=<?php echo $curso;?>&periodo=<?php echo $periodo; ?>" onclick="load(1);">Viernes</a></li>
  </ul>
...
?>
  <ul class="dropdown-menu">
    	<li><a target="_blank" href="pdf/documentos/ver_cronograma_periodo.php?cursos=<?php echo $curso; ?>&anio=<?php echo $anio; ?>&semestre=<?php echo $semestre; ?>">Lunes</a></li>
	<li><a target="_blank" href="pdf/documentos/ver_cronograma_periodo.php?dia=martes&cursos=<?php echo $curso; ?>&anio=<?php echo $anio; ?>&semestre=<?php echo $semestre; ?>">Martes</a></li>
	<li><a target="_blank" href="pdf/documentos/ver_cronograma_periodo.php?dia=miercoles&cursos=<?php echo $curso; ?>&anio=<?php echo $anio; ?>&semestre=<?php echo $semestre; ?>">Mi&eacute;rcoles</a></li>
	<li><a target="_blank" href="pdf/documentos/ver_cronograma_periodo.php?dia=jueves&cursos=<?php echo $curso; ?>&anio=<?php echo $anio; ?>&semestre=<?php echo $semestre; ?>">Jueves</a></li>
	<li><a target="_blank" href="pdf/documentos/ver_cronograma_periodo.php?dia=viernes&cursos=<?php echo $curso; ?>&anio=<?php echo $anio; ?>&semestre=<?php echo $semestre; ?>">Viernes</a></li>
	</ul>
...
<script type="text/javascript" src="js/cronograma_periodo.js"></script>
</body>
</html>
<script>
