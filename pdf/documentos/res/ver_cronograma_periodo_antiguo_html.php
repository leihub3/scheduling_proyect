...
<page backtop="5mm" backbottom="8mm" backleft="8mm" backright="8mm" style="font-size: 12pt; font-family: arial" >
   <page_footer>
        ...
        <table class="page_footer">
            <tr>
                <td style="width: 50%; text-align: left; padding-left:10px; border-color:#FFFFFF;">
	
                    <?php 				
						
					echo "CRONOGRAMA UCA - " . $_GET["periodo"] . ". A&ntilde;os de Cursado: " . $curso . ". D&iacute;a: " . $titulo;	
					?>
                </td>
            </tr>
        </table>
...
<table border="1">  
    <thead>
<tr>
  <th colspan="12" align="center">CRONOGRAMA UCA</th>
  </tr>
  <tr>
  <th colspan="12" align="center">Per&iacute;odo: <?php echo $semestre . " de " . $anio; ?>. A&ntilde;os de Cursado: <?php echo $_GET["cursos"]; ?>. D&iacute;a: <?php echo ucwords($titulo); ?></th>
  </tr>
