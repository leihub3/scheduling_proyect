...
$sWhere = " WHERE anio='".date("Y")."' && periodo='$semestre'"; //WHERE anio='".$_GET["anio"]."' && periodo='".$_GET["semestre"]."'
        ...
        <table class="page_footer">
            <tr>
                <td style="width: 100%; text-align: left; border-color:white; padding-left:10px;">
					...
					echo "CRONOGRAMA UCA - " . $semestre . " de " . date("Y") . ". A&ntilde;os de Cursado: Todos. D&iacute;a: " . $titulo;	
					?>
                </td>
            </tr>
        </table>
...
<table border="1">  
    <thead>
<tr>
  <th colspan="12" align="center">CRONOGRAMA UCA - <?php echo $semestre . " " . date("Y");?> </th>
  </tr>
  <tr>
