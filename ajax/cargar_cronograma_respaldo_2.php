...
$cursos = array("curso='1er Año'","'2do Año'","'3er Año'","'4to Año'","'5to Año'"); //$_POST['states']; // return Array
$count_cursos = count( $cursos );

if( $count_cursos > 0) {
    $curso = implode( ' OR curso= ', $cursos);   
	//echo $curso;
	//break;
}
      ...
      $sWhere = " WHERE anio='$anio' && periodo='$semestre' && $curso ";
	//echo $sTable . $sWhere;
	//break;
...
$strlen_cursos = strlen($curso_implode);
	...
	$anio_curso3 = " OR " . substr("$curso_implode",16,7);
	$anio_curso4 = " OR " . substr("$curso_implode",24,7);
	$anio_curso5 = " OR " . substr("$curso_implode",32,7);    
	$curso = $anio_curso . $anio_curso2 . $anio_curso3 . $anio_curso4 . $anio_curso5;
      ...
      $sWhere = " WHERE anio='$anio' && periodo='$semestre' && curso='$curso' ";
	
}


if(!isset($_GET["dia"])){
$sWhere = " WHERE anio='".date("Y")."'";
$dia = "lunes";
$titulo = "Lunes";
